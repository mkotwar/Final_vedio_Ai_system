...
def build_plate_ocr_outputs(run_dir: Path) -> dict[str, Any]:
    ...
    for attribute in attributes:
        ...
        result = {
            ...
            "class_source_before_correction": best_candidate.get("class_source_before_correction"),
            "corrected_class_name": best_candidate.get("corrected_class_name"),
            "corrected_vehicle_type": best_candidate.get("corrected_vehicle_type"),
            "corrected_matched_source_track_id": best_candidate.get("corrected_matched_source_track_id"),
            "corrected_matched_attribute_track_id": best_candidate.get("corrected_matched_attribute_track_id"),
            "class_correction_applied": best_candidate.get("class_correction_applied"),
            "class_correction_reason": best_candidate.get("class_correction_reason"),
            "class_correction_votes": best_candidate.get("class_correction_votes"),
            "final_class_name": best_candidate.get("final_class_name"),
            "final_vehicle_type": best_candidate.get("final_vehicle_type"),
            "vehicle_subtype_needs_review": best_candidate.get("vehicle_subtype_needs_review"),
            "vehicle_subtype_review_reason": best_candidate.get("vehicle_subtype_review_reason"),
            "possible_vehicle_classes": best_candidate.get("possible_vehicle_classes"),
            "raw_vehicle_class_name": best_candidate.get("raw_vehicle_class_name"),
            "final_vehicle_class_confidence": best_candidate.get("final_vehicle_class_confidence"),
            "safe_display_class_name": best_candidate.get("safe_display_class_name"),
            "safe_display_vehicle_type": best_candidate.get("safe_display_vehicle_type"),
    ...
    for candidate_item in filtered_frame_scan_candidates:
        ...
        if best_candidate is None:
            ...
            result = {
                ...
                "class_source_before_correction": candidate_item.get("class_source_before_correction"),
                "corrected_class_name": candidate_item.get("corrected_class_name"),
                "corrected_vehicle_type": candidate_item.get("corrected_vehicle_type"),
                "corrected_matched_source_track_id": candidate_item.get("corrected_matched_source_track_id"),
                "corrected_matched_attribute_track_id": candidate_item.get("corrected_matched_attribute_track_id"),
                "class_correction_applied": candidate_item.get("class_correction_applied"),
                "class_correction_reason": candidate_item.get("class_correction_reason"),
                "class_correction_votes": candidate_item.get("class_correction_votes"),
                "final_class_name": candidate_item.get("final_class_name"),
                "final_vehicle_type": candidate_item.get("final_vehicle_type"),
                "vehicle_subtype_needs_review": candidate_item.get("vehicle_subtype_needs_review"),
                "vehicle_subtype_review_reason": candidate_item.get("vehicle_subtype_review_reason"),
                "possible_vehicle_classes": candidate_item.get("possible_vehicle_classes"),
                "raw_vehicle_class_name": candidate_item.get("raw_vehicle_class_name"),
                "final_vehicle_class_confidence": candidate_item.get("final_vehicle_class_confidence"),
                "safe_display_class_name": candidate_item.get("safe_display_class_name"),
                "safe_display_vehicle_type": candidate_item.get("safe_display_vehicle_type"),
